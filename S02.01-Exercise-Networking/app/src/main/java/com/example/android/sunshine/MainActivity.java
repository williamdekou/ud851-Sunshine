...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO (4)(ok) Delete the dummy weather data. You will be getting REAL data from the Internet in this lesson.
        /*
         ...
         */
        // TODO (3)(ok) Delete the for loop that populates the TextView with dummy data
        /*
         * Iterate through the array and append the Strings to the TextView. The reason why we add
         * the "\n\n\n" after the String is to give visual separation between each String in the
         * TextView. Later, we'll learn about a better way to display lists of data.
         */
        // TODO (9)(ok) Call loadWeatherData to perform the network request to get the weather
        loadWeatherData();
    }
    ...
    class OpenWeatherMapQueryTask extends AsyncTask<URL, Void, String> {
        // TODO (6)(ok) Override the doInBackground method to perform your network requests
        @Override
        ...
        // TODO (7)(ok) Override the onPostExecute method to display the results of the network request
        @Override
