...
// COMPLETED (7) Generate a weather summary with the date, description, high and low
        ...
        String weatherSummary =
                SunshineDateUtils.getFriendlyDateString(mContext, mCursor.getLong(MainActivity.INDEX_WEATHER_DATE), false)
                        + " - " + SunshineWeatherUtils.getStringForWeatherCondition(mContext, mCursor.getInt(MainActivity.INDEX_WEATHER_CONDITION_ID))
